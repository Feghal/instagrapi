...
class UserMixin:
    ...
    def user_info_by_username_gql(self, username: str) -> User:
        ...
        data = extract_user_gql(json.loads(self.public_request(f'https://www.instagram.com/api/v1/users/web_profile_info/?username={username}', headers=temporary_public_headers, update_headers=update_headers))['data']['user'])
        return data
